...
const soldNumbers: { [key: number]: { buyer: string; status: "Pago ✅" | "Pendente 🙏" } } = {
  ...
  31: { buyer: "Professor Denilson PROLINFO", status: "Pago ✅"},
  ...
  43: { buyer: "Professor Denilson PROLINFO", status: "Pago ✅"},
  ...
  50: { buyer: "Professor Denilson PROLINFO", status: "Pago ✅"},
  ...
  84: { buyer: "Professor Denilson PROLINFO", status: "Pago ✅"},
